...
var snakeGameBoard = document.querySelector("#gameboard");
var scoreBoard = document.querySelector("#score");
var startGame = document.querySelector("#startGame");
;
var snakePosition = [{ x: 5, y: 6 }]; //snake array
var inputDirection = { x: 0, y: 0 };
var speed = 10;
var score = 0;
var lastPaintTime = 0;
var foodBait = { x: 10, y: 10 };
...
function gamePlay() {
    ...
    for (var i = snakePosition.length - 2; i >= 0; i--) {
        snakePosition[i + 1] = __assign({}, snakePosition[i]);
    }
    ...
    snakePosition.forEach(function (e, index) {
...
function startTimer() {
    var oneMinute = 60, display = document.querySelector("#time-left");
